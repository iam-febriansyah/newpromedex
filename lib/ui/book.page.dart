...
class _BookPageState extends State<BookPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Scaffold(
          ...
          if (provider.tagFilter.contains("isoma")) {
            return detailContentIsoma(context);
          } else {
            return detailContent(context);
          }
        })));
  }
  ...
  Widget detailContentIsoma(BuildContext context) {
    return Stack(
      children: [
                                        ...
                                        border: new Border.all(
                                            color: selected == null
                                                ...
                                                : selected == day
                                                    ...
                                                    : Colors.transparent),
                                        color: selected == day
                                            ? Color(0xFF43b752).withOpacity(0.2)
        ...
        Positioned(
          ...
          child: GestureDetector(
            onTap: () async {
              if (selected == null) {
                snackBar("pilih tanggal!");
              } else {
                transaction.serviceClientId = int.parse(widget.merchant
                    .service[widget.merchant.serviceClick].serviceClientId);
                transaction.price =
                    widget.merchant.service[widget.merchant.serviceClick].price;
                transaction.orderType = "isoma";
                transaction.dateReservation = tanggal;
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: selectedJam == item
                                ...
                                : Colors.grey.withOpacity(0.1),
                            border: Border.all(
                                color: Colors.grey.withOpacity(0), width: 1),
                            borderRadius: BorderRadius.circular(10.0),
                          ),
                          child: Center(
                            child: Text(
          ...
          child: GestureDetector(
            onTap: () async {
              if (selected == null ||
                ...
                transaction.price =
                    widget.merchant.service[widget.merchant.serviceClick].price;
                transaction.orderType = widget.merchant.orderType[selectedType];
                transaction.dateReservation = tanggal;
                transaction.hourReservation = jam;
